...
class DefinitionsBuilder:
    ...
    def _add_gradient(
        self, defs: ET.Element, gradient: Union[GradientConfig, Dict]
    ) -> None:
    ...
    def _add_gradient_from_dict(self, defs: ET.Element, gradient: Dict) -> None:
    ...
    def _create_pattern_element(
        self, pattern_elem: ET.Element, element_config: Dict
    ) -> None:
    ...
    def _create_filter_primitive(
        self, filter_elem: ET.Element, primitive_config: Dict
    ) -> None:
