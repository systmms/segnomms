...
def test_visual_consistency_workflow():
    ...
    test_configs = [
        {"name": "baseline", "config": {"shape": "rounded", "corner_radius": 0.3, "scale": 8}},
        {"name": "variant_radius", "config": {"shape": "rounded", "corner_radius": 0.5, "scale": 8}},
        {"name": "variant_shape", "config": {"shape": "circle", "corner_radius": 0.3, "scale": 8}},
    ]
