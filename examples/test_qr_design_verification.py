...
def test_basic_shapes():
    ...
    for shape in shapes:
        ...
        try:
            ...
            results.append({"shape": shape, "analysis": analysis, "svg_path": svg_path, "success": True})
...
def test_color_configurations():
    ...
    for color_test in color_tests:
        ...
        try:
            ...
            results.append({"color_test": color_test, "error": str(e), "success": False})
...
def test_finder_pattern_customization():
    ...
    finder_tests = [
        {"finder_shape": "square", "finder_inner_scale": 0.6, "finder_stroke": 0, "name": "Default Square"},
        {
            ...
            "finder_inner_scale": 0.3,
            "finder_stroke": 1,
            "name": "Small Rounded + Stroke",
        },
        {
            "finder_shape": "circle",
            "finder_inner_scale": 0.9,
            "finder_stroke": 2,
            "name": "Large Circle + Thick Stroke",
        },
    ]
    ...
    for finder_test in finder_tests:
        ...
        try:
            ...
            results.append({"finder_test": finder_test, "error": str(e), "success": False})
...
def test_interactive_features():
    ...
    for test_config in interactive_tests:
        ...
        try:
            ...
            results.append({"test_config": test_config, "error": str(e), "success": False})
...
def generate_summary_report(all_results):
    ...
    for category, results in all_results.items():
        ...
        print(
            f"Success rate: {(category_success / category_total * 100):.1f}%"
            if category_total > 0
            else "N / A"
        )
    ...
    print(
        f"Overall success rate: {(successful_tests / total_tests * 100):.1f}%" if total_tests > 0 else "N / A"
    )
