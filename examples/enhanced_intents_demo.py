...
def demo_basic_intents():
    ...
    payload = PayloadConfig(
        text="https://example.com/enhanced-demo",
...
def demo_advanced_intents():
    ...
    intents = IntentsConfig(
        ...
        reserve=ReserveIntents(
            ...
            shape="circle",
            placement="center",
            mode="knockout"  # Will show as unsupported
        ),
        ...
        animation=AnimationIntents(
            fade_in=True,  # Will show as unsupported
            fade_duration=0.5,
        ...
        performance=PerformanceIntents(
            optimize_for="size",
            max_svg_size_kb=100,
            simplify_paths=True  # Will show as unsupported
        ),
