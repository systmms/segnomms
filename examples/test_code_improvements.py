...
def test_improvements():
    ...
    for shape in connected_shapes:
        try:
            ...
            segnomms.write(
                qr, svg_path, shape=shape, scale=8, border=2, enable_phase1=True, enable_phase2=True
            )
    ...
    try:
        ...
        segnomms.write(qr, svg_path, shape="rounded", scale=8, border=2, interactive=True, tooltips=True)
    ...
    try:
        ...
        segnomms.write(qr, svg_path, shape="star", safe_mode=True, scale=8, border=2)

        # Test with safe mode OFF
        qr = segno.make("Testing safe mode OFF improvement")
        svg_path2 = "/tmp/test_safe_mode_off_improved.svg"
        segnomms.write(qr, svg_path2, shape="star", safe_mode=False, scale=8, border=2)
