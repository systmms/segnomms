...
from segnomms.degradation import (
    DegradationManager, DegradationWarning, DegradationResult,
    WarningLevel, IncompatibilityType
)
from segnomms.config import RenderingConfig, GeometryConfig, FrameConfig, CenterpieceConfig, PatternStyleConfig
...
class TestDegradationModels:
    ...
    def test_degradation_result_with_warnings(self):
        ...
        # Add warnings
        result.warnings.append(DegradationWarning(
