...
from tests.constants import DEFAULT_SCALE, TEST_COLORS, ModuleShape
...
class TestTypeAliases:
    ...
    def test_performance_metrics_type_structure(self):
        ...
        valid_metrics: List[PerformanceMetricsType] = [
            ...
            {"total_time": 1.5, "render_time": 0.8, "validation_time": 0.2, "errors": []},
            {},  # Empty metrics
        ]
    ...
    def test_validation_result_type_structure(self):
        ...
        valid_results: List[ValidationResultType] = [
            {"is_valid": True, "message": "Validation passed", "errors": []},
            {
                "scannable": False,
                "reason": "Insufficient contrast",
                "suggestions": ["Increase color contrast", "Simplify design"],
            },
            {"structure_valid": True, "accessibility_valid": False, "warnings": ["Missing alt text"]},
            {},  # Empty result
        ]
...
class TestCenterpieceConfigProtocol:
    ...
    def test_centerpiece_protocol_compliance(self):
        ...
        mock_centerpiece.model_dump.return_value = {"enabled": True, "size": 0.15, "shape": "circle"}
...
class TestUnionTypes:
    ...
    def test_centerpiece_config_type_accepts_various_inputs(self):
        ...
        # Should accept dictionary
        centerpiece_dict: CenterpieceConfigType = {"enabled": True, "size": 0.15, "shape": "circle"}
...
class TestTypeValidation:
    ...
    def test_matrix_validation(self):
        ...
        # Valid matrices
        valid_matrices = [[[1, 0, 1], [0, 1, 0]], [[None, 1], [1, None]], []]
