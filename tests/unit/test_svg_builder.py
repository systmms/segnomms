...
from segnomms.svg.models import (
    SVGElementConfig, BackgroundConfig, GradientConfig,
    TitleDescriptionConfig, InteractionConfig
)
from segnomms.a11y.accessibility import (
    AccessibilityConfig, create_basic_accessibility, create_enhanced_accessibility
)
...
class TestSVGRootCreation:
    ...
    def test_create_svg_root_with_title_and_description(self, builder):
        ...
        svg = builder.create_svg_root(
            200, 200, 
            title="Test QR Code",
            description="A QR code for testing purposes"
        )
...
class TestTitleAndDescription:
    ...
    def test_add_title_and_description_basic(self, builder, sample_svg):
        ...
        builder.add_title_and_description(
            sample_svg,
            title="Test QR Code",
            description="A QR code for testing"
        )
...
class TestFrameDefinitions:
    ...
    @patch('segnomms.shapes.frames.FrameShapeGenerator')
    def test_add_frame_definitions_rounded_rect(self, mock_generator_class, builder, sample_svg, mock_frame_config):
        """Test frame definitions for rounded rectangle."""
        mock_generator = Mock()
        mock_generator_class.return_value = mock_generator
        mock_generator.generate_rounded_rect_clip.return_value = '<rect x="10" y="10" width="180" height="180" rx="20"/>'
    ...
    @patch('segnomms.shapes.frames.FrameShapeGenerator')
    def test_add_frame_definitions_fade_mode(self, mock_generator_class, builder, sample_svg, mock_frame_config):
    ...
    @patch('segnomms.shapes.frames.FrameShapeGenerator')
    def test_add_frame_definitions_custom_path_valid(self, mock_generator_class, builder, sample_svg, mock_frame_config):
    ...
    @patch('segnomms.shapes.frames.FrameShapeGenerator')
    def test_add_frame_definitions_custom_path_invalid(self, mock_generator_class, builder, sample_svg, mock_frame_config):
...
class TestCenterpieceMetadata:
    ...
    def test_add_centerpiece_metadata_basic(self, builder, sample_svg, mock_centerpiece_config, sample_bounds):
    ...
    def test_add_centerpiece_metadata_pixel_conversion(self, builder, sample_svg, mock_centerpiece_config, sample_bounds):
    ...
    def test_add_centerpiece_metadata_namespace_registration(self, builder, sample_svg, mock_centerpiece_config, sample_bounds):
...
class TestSVGBuilderIntegration:
    ...
    def test_complete_svg_building_workflow(self, builder):
        ...
        builder.add_title_and_description(
            svg,
            title="Complete Test QR",
            description="A fully-featured test QR code"
        )
