...
class TestPerformanceMonitor:
    ...
    def test_threshold_checking(self, monitor):
        ...
        threshold = PerformanceThreshold(
            operation="test_op", max_time_ms=1.0, warning_level=WarningLevel.WARNING  # 1ms threshold
        )
    ...
    def test_measure_operation_method(self, monitor):
        ...
        result = monitor.measure_operation(
            "test_function", test_function, 5, 10, complexity_func=complexity_calc
        )
    ...
    def test_recent_warnings(self, monitor):
        ...
        threshold = PerformanceThreshold(
            operation="warn_test", max_time_ms=1.0, warning_level=WarningLevel.ERROR
        )
        monitor.set_threshold(threshold)
...
class TestPerformanceDecorators:
    ...
    def test_centerpiece_operation_decorator(self):
        ...
        manipulator = MockManipulator()
        config = CenterpieceConfig(size=0.2, mode=ReserveMode.IMPRINT)
    ...
    def test_imprint_rendering_decorator(self):
        ...
        class MockRenderer:
            def get_imprint_metadata(self):
                return {"imprinted_modules": [{"row": i, "col": i} for i in range(10)]}
...
class TestPerformanceThreshold:
    ...
    def test_threshold_time_check(self):
        ...
        threshold = PerformanceThreshold(
            operation="test", max_time_ms=100.0, warning_level=WarningLevel.WARNING
        )
    ...
    def test_threshold_complexity_check(self):
        ...
        threshold = PerformanceThreshold(
            operation="test", max_time_ms=1000.0, max_complexity=500, warning_level=WarningLevel.INFO
        )
        ...
        threshold_no_complexity = PerformanceThreshold(
            operation="test", max_time_ms=1000.0, warning_level=WarningLevel.WARNING
        )
...
class TestPerformanceMetric:
    ...
    def test_metric_exceeded_threshold_property(self):
        ...
        metric1 = PerformanceMetric(operation="test", start_time=0.0, end_time=0.1, elapsed_ms=100.0)
