...
class TestPhase4Integration:
    ...
    def test_gradient_quiet_zone(self, test_qr, tmp_path):
        ...
        quiet_zone = None
        for elem in root.iter():
            if ('rect' in elem.tag and 
                elem.get('class') == 'segnomms-quiet-zone'):
                quiet_zone = elem
                break
    ...
    def test_frame_clipping_with_clustering(self, test_qr, tmp_path):
        ...
        shape_elements = [elem for elem in modules.iter() 
    ...
    def test_layered_svg_structure(self, test_qr, tmp_path):
        ...
        assert any('rect' in child.tag and 'quiet-zone' in child.get('class', '') 
    ...
    def test_no_phase4_features_baseline(self, test_qr, tmp_path):
        ...
        write(
            ...
            scale=10,
            border=4,
            shape='square'  # No Phase 4 features
        )
