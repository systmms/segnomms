...
class TestPluginRegistration:
    ...
    @pytest.mark.skipif(
        not hasattr(segno.QRCode, 'to_interactive_svg'),
        reason="Plugin not installed via pip"
    )
...
class TestShapeAvailability:
    ...
    def test_shape_categories(self):
        ...
        basic_shapes = {
            ...
            "star", "triangle", "hexagon", "cross"
        }
        
        connected_shapes = {
            "connected", "connected-rounded", 
            "connected-diamond", "connected-extra-rounded"
        }
