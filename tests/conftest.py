...
def svg_to_png(svg_content: str, output_path: Optional[Path] = None, return_bytes: bool = False):
    ...
    if output_path:
        print(f"Warning: No SVG to PNG converter available. PNG output skipped for {output_path.name}")
    else:
        print("Warning: No SVG to PNG converter available.")
    print("Install one of: cairosvg (pip), or ensure rsvg-convert/imagemagick is in PATH")
...
@pytest.fixture
def visual_regression_tester(visual_baseline_dir, visual_output_dir, visual_diff_dir):
