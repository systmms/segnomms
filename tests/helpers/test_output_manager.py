    ...
    def _config_to_kwargs(self, config: RenderingConfig) -> Dict[str, Any]:
        ...
        if hasattr(config, 'geometry'):
            ...
            if hasattr(geo, 'connectivity'):
                kwargs['connectivity'] = geo.connectivity.value if hasattr(geo.connectivity, 'value') else geo.connectivity
        ...
        if hasattr(config, 'finder'):
            ...
            if hasattr(finder, 'shape'):
                kwargs['finder_shape'] = finder.shape.value if hasattr(finder.shape, 'value') else finder.shape
