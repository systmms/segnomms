...
- [ ] T039 [P] [US7] Add Sphinx cross-references to `docs/source/shapes.rst` using `:doc:` and `:ref:`
- [ ] T040 [P] [US7] Document safe mode scope in `docs/source/shapes.rst` - explicit list of protected vs unprotected patterns
- [ ] T041 [P] [US7] Add ECC level table to `docs/source/decoder_compatibility.rst` (L=7%, M=15%, Q=25%, H=30%)
- [ ] T042 [P] [US7] Create comprehensive Phase 4 feature reference in one location (choose appropriate RST file)
- [ ] T043 [P] [US7] Fix or remove shape gallery references in `docs/source/shapes.rst`
- [ ] T044 [P] [US7] Fix or remove Nix environment references in `README.md`
- [ ] T045 [P] [US7] Document performance testing framework in `docs/source/testing/` (create directory if needed)
- [ ] T046 [P] [US7] Audit code blocks in all RST files for proper language tags (python, bash, css)
- [ ] T047 [US7] Validate cross-references resolve using `python repo/validate_docs_references.py`
...
- [ ] T048 [P] [US8] Add beta status notice to `README.md` introduction section
- [ ] T049 [P] [US8] Add beta status notice to `docs/source/installation.rst`
- [ ] T050 [US8] Verify beta notices are prominent and clear
...
- [ ] T051 [P] Document spec-kit workflow in `docs/source/contributing.rst`
- [ ] T052 [P] Remove all "segno-interactive-svg" references from documentation (comprehensive grep)
- [ ] T053 [P] Add "Development Commands" section to `README.md` referencing `make help`
- [ ] T054 [P] Fix CHANGELOG.md backslash typo on line 18 (`### refactor\` → `### refactor`)
- [ ] T055 [P] Final audit of code block language tags across all RST files
- [ ] T056 [P] Final audit of Sphinx cross-references across all RST files
- [ ] T057 Build Sphinx documentation and verify zero warnings: `make docs 2>&1 | grep -i warning`
- [ ] T058 Run comprehensive validation script: `python scripts/verify_documentation_fixes.py`
- [ ] T059 Verify all 27 functional requirements (FR-001 through FR-027) addressed
- [ ] T060 Verify all 7 success criteria (SC-001 through SC-007) met
